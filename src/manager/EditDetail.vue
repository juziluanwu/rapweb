<template>
    <div v-show="isShow" class="menuedit">
        <div v-show="!isShowInfo" slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" style="margin-right:20px;" class="pull-right" @click="formatSome()">格式化
            </el-button>
        </div>
        <el-form :model="interfaceDetail" label-width="80px" size="mini">
            ...
            <el-form-item label="响应参数:" v-show="interfaceDetail.type==3">
                ...
                <span v-show="isShowInfo"
                      v-html="interfaceDetail.responseparam">{{interfaceDetail.responseparam}}</span>
            </el-form-item>
        </el-form>
        <div v-show="!isShowInfo" slot="footer" class="dialog-footer">
            <el-button type="primary" class="pull-right" @click="addOrEdit()">确 定</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            addOrEdit() {
                ...
                this.interfaceDetail.version = localStorage.getItem(this.interfaceDetail.pid)
